package com.example.boycottapp.presentation.gemini_page_view
...
import com.example.boycottapp.domain.model.Message
            ...
            Row(
                ...
                Card(
                    colors = CardDefaults.cardColors(
                        containerColor = if (isCurrentUser) Color.Blue else Color.Green
                    ),
                    modifier = Modifier
                        .widthIn(max = 300.dp)
                        .padding(8.dp)
